...
require (
	cloud.google.com/go/aiplatform v1.96.0
	github.com/GoogleCloudPlatform/vertex-ai-creative-studio/experiments/mcp-genmedia/mcp-genmedia-go/mcp-common v0.0.0-20250725022308-b08f4156c25c
