...
class VideoInfiniteScrollLibrary extends LitElement {
  static properties = {
    ...
    imageSelectedEvent: { type: String }, // Keep the same event name for compatibility
  };
...
customElements.define('video-infinite-scroll-library', VideoInfiniteScrollLibrary);